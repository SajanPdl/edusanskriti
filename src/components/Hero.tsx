...
import { BookOpen, FileText, GraduationCap, Download, Search, Phone, Laptop, Clipboard, Book, Beaker, Home, Bookmark, User, Bell, MessageSquare, Microscope } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="lg:w-1/2 mt-10 lg:mt-0 animate-fade-in">
            <div className="relative mx-auto" style={{ maxWidth: '380px' }}>
                ...
                <div className="h-[572px] w-[272px] bg-white dark:bg-gray-900 overflow-hidden">
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-auto">
                      {/* Featured banner */}
                      <div className="bg-gradient-to-r from-pink-500 to-purple-500 m-3 rounded-xl p-4 text-white">
                        ...
                        <button className="bg-white text-purple-600 text-xs px-3 py-1 rounded-full font-medium">
                          Update Now
                        </button>
                      </div>
                          ...
                          {['Notes', 'Papers', 'Quizzes', 'Books'].map((cat, index) => (
                            <div key={index} className="flex flex-col items-center">
                              <div className={`h-10 w-10 rounded-full flex items-center justify-center mb-1 ${
                                index % 4 === 0 ? 'bg-purple-100 text-edu-purple' :
                                index % 4 === 1 ? 'bg-blue-100 text-edu-blue' :
                            ...
                            <div key={index} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                              <div className="flex gap-2">
                                <div className={`h-10 w-10 rounded-lg flex items-center justify-center ${
                                  index % 3 === 0 ? 'bg-purple-100 text-edu-purple' :
                                  index % 3 === 1 ? 'bg-blue-100 text-edu-blue' :
                              ...
                              <div key={index} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 w-36 shrink-0 shadow-sm">
                                <div className={`h-20 rounded-lg mb-2 ${
                                  ...
                                  {index % 3 === 0 && <BookOpen className={`h-8 w-8 ${
                                    index % 3 === 0 ? 'text-edu-purple' :
                                    index % 3 === 1 ? 'text-edu-blue' :
                                    'text-edu-orange'
                                  }`} />}
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 p-2 bg-white dark:bg-gray-900">
                      <div className="flex justify-around">
                        {['Home', 'Search', 'Saved', 'Profile'].map((item, index) => (
                          <div key={index} className={`flex flex-col items-center p-1 ${index === 0 ? 'text-edu-purple' : 'text-gray-500'}`}>
              ...
              {/* Download badge */}
              <div className="absolute -bottom-4 -right-4 bg-gradient-to-r from-edu-orange to-edu-gold text-white px-4 py-2 rounded-full shadow-lg animate-bounce-subtle">
